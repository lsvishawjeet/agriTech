  ...
  return (
    <div className='md:m-9 ml-5 mr-5 flex flex-col  '>
      ...
      <div className='md:w-3/4 mt-5'>
        <span className='text-sm md:text-sm'>Enter details of your soil and weather, and find best suitable crop for farming. With our advanced AI system, you can make informed decisions and optimize your agricultural practices.</span>
      </div>
      <div className='mt-10'>
